...
abstract class AbstractScompTest extends AnyFreeSpec with should.Matchers with ScalaCheckPropertyChecks {
  extension (gen: Gen.type) {
    ...
    /** Generates an instance of the `Num` class with a potentially randomized numeric value.
      ...
      */
    protected def num(value: Gen[Int] = Gen.int()): Gen[ast.terminal.Num] =
    ...
    /** Generates an instance of the `Num` class from the `ast.terminal` package.
      ...
      *   generation.
      */
    protected def terminal: Gen[ast.terminal.Num] = gen.num()
    ...
    /** Generates an instance of the `Increment` class from the `ast.unary` package.
      ...
      */
    protected def increment(maxDepth: Int = 5): Gen[ast.unary.Increment] =
    ...
    /** Generates an instance of the `Expr` class from the `ast` package, representing an expression.
      ...
      */
    protected def expr(maxDepth: Int = 5): Gen[ast.Expr] = maxDepth match {
      case 0 => gen.terminal
